...
class DynamicLighting{addCircleLightSource(e,t,a){this.circleLightSources.push({radius:e,x:t,y:a})}addConeLightSource(e,t,a,r,c,o){this.coneLightSources.push({x:e,y:t,centerDistance:a,directionAngle:r,innerAngle:c,distance:o})}addRectangleLightSource(e){this.rectangleLightSources.push(e)}
render(e,t){
	...
	}constructor(e){this.lighting=e,this.circleLightSources=[],this.coneLightSources=[],this.rectangleLightSources=[]}}
...
function $01bb7fd9b3660a1e$export$51b0c51f5b2e9c35(e) {
	for (let t = 0; t < $3d7c57289a41f86c$exports.abilities.length; t++) {
		const a = $3d7c57289a41f86c$exports.abilities[t];
		if (a.name === e)
			return a
	}
	return null
...
function $01bb7fd9b3660a1e$export$96671014a1dabc4c(e) {
	for (let t = 0; t < $3d7c57289a41f86c$exports.effects.length; t++) {
		const a = $3d7c57289a41f86c$exports.effects[t];
		if (a.type === e)
			return a
	}
	return null
