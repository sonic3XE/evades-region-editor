...
class TitleText extends $cee3aa9d42503f73$export$2e2bcd8739ae039 {
	stateFields() {
		return ["heroType", "areaName", "areaNumber", "regionName", "victoryArea", "survivalTime"]
	}
	afterStateUpdate() {
	...
	render(e, t) {
		...
		this.victoryArea ? c = `${this.regionName}: Victory!` : o % 10 == 0 && ["Peculiar Pyramid", "Peculiar Pyramid Hard", "Haunted Halls", "Ominous Occult", "Ominous Occult Hard", "Toxic Territory", "Toxic Territory Hard", "Magnetic Monopole", "Magnetic Monopole Hard", "Burning Bunker", "Burning Bunker Hard", "Assorted Alcove", "Assorted Alcove Hard", "Restless Ridge Hard", "Grand Garden", "Grand Garden Hard", "Mysterious Mansion", "Coupled Corridors", "Cyber Castle", "Cyber Castle Hard", "Shifting Sands", "Infinite Inferno", "Dusty Depths"].indexOf(this.regionName) < 0 && (c = `${this.regionName}: BOSS AREA ${this.areaName}`);
		const n = as.width / 2;
