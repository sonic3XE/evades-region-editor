...
class MysteryEnemy extends Enemy{
  ...
  update(){
	  var list="wall_enemy,normal_enemy,homing_enemy,dasher_enemy,slowing_enemy,experience_drain_enemy,enlarging_enemy,draining_enemy,gravity_enemy,repelling_enemy,turning_enemy,sizing_enemy,sniper_enemy,freezing_enemy,teleporting_enemy,wavy_enemy,zigzag_enemy,zoning_enemy,spiral_enemy,oscillating_enemy,switch_enemy,liquid_enemy,icicle_enemy,slippery_enemy,ice_sniper_enemy,disabling_enemy,speed_sniper_enemy,regen_sniper_enemy,radiating_bullets_enemy,immune_enemy,pumpkin_enemy,tree_enemy,frost_giant_enemy,snowman_enemy,corrosive_enemy,toxic_enemy,corrosive_sniper_enemy,poison_sniper_enemy,magnetic_reduction_enemy,magnetic_nullification_enemy,positive_magnetic_sniper_enemy,negative_magnetic_sniper_enemy,residue_enemy,fire_trail_enemy,ice_ghost_enemy,poison_ghost_enemy,positive_magnetic_ghost_enemy,negative_magnetic_ghost_enemy,wind_ghost_enemy,lunging_enemy,lava_enemy,gravity_ghost_enemy,repelling_ghost_enemy,star_enemy,grass_enemy,seedling_enemy,flower_enemy,disabling_ghost_enemy,glowy_enemy,firefly_enemy,mist_enemy,phantom_enemy,cybot_enemy,eabot_enemy,wabot_enemy,fibot_enemy,aibot_enemy,wind_sniper_enemy,sand_enemy,sandrock_enemy,quicksand_enemy,crumbling_enemy,radar_enemy,barrier_enemy,speed_ghost_enemy,regen_ghost_enemy,cactus_enemy,cycling_enemy,icbot_enemy,elbot_enemy,plbot_enemy,mebot_enemy,libot_enemy,dabot_enemy,sparking_enemy,thunderbolt_enemy,static_enemy,electrical_enemy,prediction_sniper_enemy,ring_sniper_enemy,charging_enemy,reducing_enemy,lead_sniper_enemy,stalactite_enemy,blocking_enemy,force_sniper_a_enemy,force_sniper_b_enemy,flaming_enemy,stumbling_enemy,disarming_enemy,lurching_enemy,infectious_enemy,mutating_enemy,vengeful_soul_enemy,lost_soul_enemy,reverse_projectile,minimize_projectile,reanimate_projectile,sniper_projectile,vengeance_projectile,latch_projectile,black_hole_projectile,spark_projectile,lightning_projectile,shadow_projectile,obscure_projectile,ice_sniper_projectile,snowball_projectile,speed_sniper_projectile,regen_sniper_projectile,radiating_bullets_projectile,leaf_projectile,frost_giant_ice_projectile,stalactite_enemy_projectile,orbit_projectile,corrosive_sniper_projectile,poison_sniper_projectile,positive_magnetic_sniper_projectile,negative_magnetic_sniper_projectile,crumble_projectile,radioactive_gloop_projectile,bloom_projectile,pollinate_projectile,seedling_projectile,flower_projectile,soulstone_projectile,grave_projectile,elbot_projectile,libot_projectile,dabot_projectile,wind_sniper_projectile,radar_projectile,robo_scanner_sniper_projectile,robo_scanner_ice_sniper_projectile,robo_scanner_speed_sniper_projectile,robo_scanner_regen_sniper_projectile,robo_scanner_radiating_bullets_projectile,robo_scanner_leaf_projectile,robo_scanner_corrosive_sniper_projectile,robo_scanner_poison_sniper_projectile,robo_scanner_positive_sniper_projectile,robo_scanner_negative_sniper_projectile,robo_scanner_wind_sniper_projectile,robo_scanner_radar_projectile,robo_scanner_prediction_sniper_projectile,robo_scanner_lead_sniper_projectile,robo_scanner_force_a_projectile,robo_scanner_force_b_projectile,robo_scanner_flower_projectile,robo_scanner_frost_giant_ice_projectile,echelon_projectile,incinerate_projectile,petrify_projectile,ictos_projectile,sparking_enemy_projectile,electrical_enemy_projectile,prediction_sniper_projectile,ring_sniper_projectile,cybot_ring_projectile,lead_sniper_projectile,force_sniper_a_projectile,force_sniper_b_projectile,factorb_explosion".split(",")
	  this.type=list[Math.floor(Math.random()*list.length)]
  }
}
