...
spawnEntities(current_Area)}else{
  ...
  ctx.strokeText(`ゾーンの数: ${area.zones.length}`,canvas.width/2,55),ctx.fillText(`ゾーンの数: ${area.zones.length}`,canvas.width/2,55),
  ctx.strokeText(`資産の数: ${area.assets.length}`,canvas.width/2,80),ctx.fillText(`資産の数: ${area.assets.length}`,canvas.width/2,80),
  ctx.strokeText(`エンティティの数: ${area.entities.length}`,canvas.width/2,105),ctx.fillText(`エンティティの数: ${area.entities.length}`,canvas.width/2,105));
